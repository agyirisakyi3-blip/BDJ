...
export default memo(function MonthSummary() {
  ...
  const note = s.days >= 15
    ? 'Excellent rythme ce mois-ci — continuez comme ça !'
    : 'Vos jours et heures de présence cumulés depuis le 1er du mois.';
    ...
    return (
      <section className="card block" id="month-card">
        ...
        <div className="month-empty">
          ...
          <p>Pas encore de pointage ce mois-ci. Scannez le QR à l'entrée pour commencer !</p>
        </div>
      </section>
    );
  }
